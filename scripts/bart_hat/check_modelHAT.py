...
class BartMultiEncHATTester():
    ...
    def test_model_forward_bart_encoder_flat(self, encoder_combination_type):
        from BartMultiEncFlattened_HAT import BartMultiEncFlatHAT
        
        model = BartMultiEncFlatHAT.from_pretrained('facebook/bart-base')
...
obj.test_model_forward_bart_encoder_flat(encoder_combination_type='self_attention')
